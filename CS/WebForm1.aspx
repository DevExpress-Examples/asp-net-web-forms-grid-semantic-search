...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxGridView ID="ASPxGridView1" runat="server" ClientInstanceName="grid" KeyFieldName="ID" Width="1000" AutoGenerateColumns="False" OnCustomCallback="ASPxGridView1_CustomCallback">
                <Columns>
